program calculate_min_max
    ...
    100 format(/, 1x, 'Min value occured at x = ', F10.3,/, ' Min value              = ', F10.3,/, &
               1x, 'Max value occured at x = ', F10.3,/, ' Max value              = ', F10.3,/)
    ...
    subroutine min_max(first_value, last_value, num_steps, func, xmin, min_value, xmax, max_value)
        ...
        step_size = (last_value - first_value) / num_steps
        
        do i = 1, num_steps
            temp = func(first_value + i * step_size)
